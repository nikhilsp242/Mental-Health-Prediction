...
class Dictionary(object):
    ...
    def tokens_to_tensor(self, tokens: List[str], max_len: Optional[int]=None):
        """tokens_to_tensor
        :param tokens:
        :type tokens: List[str], a list of tokens to be converted to IDs
        :param max_len: If provided, tokens will be truncated when they exceed max_len, and padded when they are shorter.
