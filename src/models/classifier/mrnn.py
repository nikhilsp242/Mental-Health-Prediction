...
from config import MRNNClassifierConfig
from .base import Classifier
from .components import RNN


class MRNNClassifier(Classifier):
    def __init__(self, config: MRNNClassifierConfig):
        super(MRNNClassifier, self).__init__(config)
